...
print("Initial Attributes:",whiskers.name,"("+whiskers.species+")","- Hunger: ",whiskers.hunger,",","Energy:",whiskers.energy)
...
print("Modified Attributes:",whiskers.name,"("+whiskers.species+")","- Hunger: ",whiskers.hunger,",","Energy:",whiskers.energy)